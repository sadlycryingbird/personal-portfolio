...
describe("About Page", () => {
  it("renders all headings properly and accurately", () => {
    ...
    expect(
      screen.getAllByRole("heading").find((h) => h.textContent === "About Me")
    ).toBeInTheDocument();
    expect(
      screen.getAllByRole("heading").find((h) => h.textContent === "My Experience")
    ).toBeInTheDocument();
    expect(
      screen.getAllByRole("heading").find((h) => h.textContent === "Let's Connect")
    ).toBeInTheDocument();
  });
